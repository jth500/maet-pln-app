...
def article_selection_buttons():
    s = "Select a random news article or input your own. Our RLAIF model will summarise it!"
    st.write(s)
...
def summary_selection_button():
    s = "Select a random article and compare the summaries generated by our SFT models."
    st.write(s)
